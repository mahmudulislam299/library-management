    ...
    <div className="dashboard">
      <div className="dashboard-card">
        ...
        <div className="dashboard-option-content">
          {/* Profile */}
          <div className="content-wrapper" style={active !== "profile" ? { display: "none" } : {}}>
            <div className="member-profile-content">
              <div className="user-details-topbar">
                ...
                <div className="user-info">
                  <p className="user-name">{memberDetails?.userFullName || "Loading..."}</p>
                  <p className="user-id">
              ...
              <div className="user-details-specific">
                ...
                <div className="specific-right">
                  ...
                  <div className="specific-right-bottom">
                    ...
                    <p className="points-value">{memberDetails?.points || 0}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Issued Books */}
          <div className="content-wrapper" style={active !== "active" ? { display: "none" } : {}}>
              ...
              <table className="activebooks-table">
                ...
                <tbody>
                  {memberDetails?.activeTransactions
                    ...
                    .map((t, i) => {
                      const fine = Math.max(0,
                        Math.floor((Date.now() - new Date(t.toDate)) / 86400000) * 10
                      );
                      return (
                        <tr key={i}>
                          <td>{i + 1}</td>
          ...
          {/* Reserved Books */}
          <div className="content-wrapper" style={active !== "reserved" ? { display: "none" } : {}}>
          ...
          {/* History */}
          <div className="content-wrapper" style={active !== "history" ? { display: "none" } : {}}>
